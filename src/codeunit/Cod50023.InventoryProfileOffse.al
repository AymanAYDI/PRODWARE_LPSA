codeunit 50023 "PWD Inventory Profile Offse."
{
        ...
        if SupplyInvtProfile.FindSet() then
            repeat
                if SupplyInvtProfile."Untracked Quantity" > 0 then begin
                    if DecreaseQty(SupplyInvtProfile, SupplyInvtProfile."Untracked Quantity", false) then
    ...
    begin
        ...
        // if FromLotAccumulationPeriodStartDate(LotAccumulationPeriodStartDate, DemandInvtProfile."Due Date") then////////////////////// testt
    ...
    var
        ...
        DemandDueDate: Date;
    begin
        // if FromLotAccumulationPeriodStartDate(LotAccumulationPeriodStartDate, DemandInvtProfile."Due Date") then begin //// TEST
        //     NewSupplyDate := LotAccumulationPeriodStartDate;
    ...
    begin
        ...
        // SupplyInvtProfile."Remaining Quantity (Base)" += NeededQty +
        //   AdjustReorderQty(
        //     SupplyInvtProfile."Remaining Quantity (Base)" + NeededQty, TempSKU, SupplyInvtProfile."Line No.", SupplyInvtProfile."Min. Quantity");
    ...
    var
        TempQty: Decimal;
    begin
        OnBeforeDecreaseQty(SupplyInvtProfile, ReduceQty, TempSKU);
    ...
    begin
        ...
        CASE DemandInvtProfile."Source Type" OF
            DATABASE::"Sales Line":
                //IF RecLSalesLine.GET(Demand."Source Order Status",Demand."Source ID",Demand."Source Ref. No.") THEN BEGIN
                IF DemandInvtProfile."PWD Transmitted Order No." THEN BEGIN
                    SupplyInvtProfile."PWD Original Source Id" := DemandInvtProfile."PWD Original Source Id";
                    SupplyInvtProfile."PWD Original Source No." := DemandInvtProfile."PWD Original Source No.";
                    SupplyInvtProfile."PWD Original Source Position" := DemandInvtProfile."PWD Original Source Position";
                    SupplyInvtProfile."PWD Original Counter" := 0;
                    SupplyInvtProfile."PWD Transmitted Order No." := TRUE;
                END;
            DATABASE::"Planning Component":
                IF RecLReqLine.GET(DemandInvtProfile."Source ID", DemandInvtProfile."Source Batch Name", DemandInvtProfile."Source Prod. Order Line") THEN
                    IF RecLReqLine."PWD Transmitted Order No." THEN BEGIN
                        SupplyInvtProfile."PWD Original Source Id" := RecLReqLine."PWD Original Source Id";
                        SupplyInvtProfile."PWD Original Source No." := RecLReqLine."PWD Original Source No.";
                        SupplyInvtProfile."PWD Original Source Position" := RecLReqLine."PWD Original Source Position";
                        SupplyInvtProfile."PWD Transmitted Order No." := TRUE;
                        RecLReqLine.RESET();
                        RecLReqLine.SETRANGE("PWD Original Source Id", SupplyInvtProfile."PWD Original Source Id");
                        RecLReqLine.SETRANGE("PWD Original Source No.", SupplyInvtProfile."PWD Original Source No.");
                        RecLReqLine.SETRANGE("PWD Original Source Position", SupplyInvtProfile."PWD Original Source Position");
                        IF RecLReqLine.FINDLAST() THEN
                            SupplyInvtProfile."PWD Original Counter" := RecLReqLine."PWD Original Counter" + 1;
                    END;
            DATABASE::"Prod. Order Component":
                IF RecLProdOrder.GET(DemandInvtProfile."Source Order Status", DemandInvtProfile."Source ID") THEN
                    IF RecLProdOrder."PWD Transmitted Order No." THEN BEGIN
                        SupplyInvtProfile."PWD Original Source Id" := DemandInvtProfile."Source Type";
                        SupplyInvtProfile."PWD Original Source No." := RecLProdOrder."PWD Original Source No.";
                        SupplyInvtProfile."PWD Original Source Position" := RecLProdOrder."PWD Original Source Position";
                        SupplyInvtProfile."PWD Original Counter" := 1;
                        SupplyInvtProfile."PWD Transmitted Order No." := TRUE;
                    end;
        end;
        //<<FE_LAPIERRETTE_PROD01.001: TO 13/12/2011
        ...
        then
            if SupplyInvtProfile."Planning Line No." = 0 then
                with ReqLine do begin
                    ...
                    UpdateDatetime();
                    //>>FE_LAPIERRETTE_PROD01.001: TO 13/12/2011
                    "PWD Original Source Id" := SupplyInvtProfile."PWD Original Source Id";
                    "PWD Original Source No." := SupplyInvtProfile."PWD Original Source No.";
                    "PWD Original Source Position" := SupplyInvtProfile."PWD Original Source Position";
                    "PWD Original Counter" := SupplyInvtProfile."PWD Original Counter";
                    "PWD Transmitted Order No." := SupplyInvtProfile."PWD Transmitted Order No.";
                    //<<FE_LAPIERRETTE_PROD01.001: TO 13/12/2011
    ...
    begin
        ...
        ToInvProfile."PWD Original Source No." := FromInvProfile."PWD Original Source No.";
        ToInvProfile."PWD Original Source Position" := FromInvProfile."PWD Original Source Position";
        ToInvProfile."PWD Original Counter" := FromInvProfile."PWD Original Counter";
        ToInvProfile."PWD Transmitted Order No." := FromInvProfile."PWD Transmitted Order No.";
        IF ((ToInvProfile."PWD Transmitted Order No." = TRUE) AND (ToInvProfile."PWD Original Source Id" = 5407)) THEN
            ToInvProfile."PWD Original Counter" := Fct_CalcCounter(ToInvProfile."PWD Original Source No.", ToInvProfile."PWD Original Source Position");
        //<<FE_LAPIERRETTE_PROD01.001: TO 13/12/2011
    ...
    BEGIN
        IntLCounter := 0;
        RecLReqLine.RESET();
        RecLReqLine.SETRANGE("PWD Original Source No.", CodPSourceNo);
        RecLReqLine.SETRANGE("PWD Original Source Position", IntPSourcePos);
        //>>TDL_12_06_18.001
        IF RecLReqLine.FINDSET() THEN
            REPEAT
                IF IntLCounter < RecLReqLine."PWD Original Counter" THEN
                    IntLCounter := RecLReqLine."PWD Original Counter";
    ...
    [IntegrationEvent(false, false)]
    local procedure OnBeforeDecreaseQty(var SupplyInvtProfile: Record "Inventory Profile"; ReduceQty: Decimal; var SKU: Record "Stockkeeping Unit")
    begin
    end;
