codeunit 50009 "PWD Test Closing Management"
{
    // +----------------------------------------------------------------------------------------------------------------+
    // | ProdWare                                                                                                       |
    // | www.prodware.fr                                                                                                |
    ...
    // TDL21072020.001 : LY 21/07/2020 : Ajout de champ en export, ajout de critères
    ...
    var
        ...
        CstLItem: Label 'Test_Articles_%1.csv';
    ...
    var
        ...
        RecLLastSalesOrderLine: Record "Sales Line";
        RecLWarehouseEntry: Record "Warehouse Entry";
        CstLInventory: Label 'Test_Stocks_%1.csv';
    ...
    begin
        ...
        //>>TDL21072020.001
        // 17 - Système réappro.
        TxtLTextFields[17] := 'Système réappro.';

        // 18 - Cout unitaire
        //TxtLTextFields[18] := 'Prix unitaire';
        TxtLTextFields[18] := 'Coût standard';

        // 19 - Dernier prix de vente
        TxtLTextFields[19] := 'Dernier prix vente';
                    ...
                    if RecLBinContent.FindSet() then
                        repeat
                            ...
                            if RecLBinContent.Quantity <> 0 then begin
                                ...
                                // 7 - Coût unitaire
                                if RecLItem."Replenishment System" = RecLItem."Replenishment System"::Purchase then
                                ...
                                //>>TDL21072020.001
                                // 17 - Système réappro.
                                TxtLTextFields[17] := Format(RecLItem."Replenishment System");
    ...
    begin
        ...
        TxtPTextFields[12] := Format(DecLValueOfMatConsump + DecLValueOfCap + DecLValueOfCapVendor + DecLValueOfOutput);
    end;
