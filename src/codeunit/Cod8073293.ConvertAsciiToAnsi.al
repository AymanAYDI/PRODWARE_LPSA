codeunit 8073293 "PWD Convert Ascii To Ansi"
{
    // +----------------------------------------------------------------------------------------------------------------+
    ...
    begin
        ...
        for pos := 1 to StrLen(TextAscii) do
            if (TextAnsi[pos] > 127) then begin                      //different chars after 127
                ...
                while ((Found = false) and (i < 88)) do begin       //array of 87 elements
                                                                    //<<LAP2.14
                    i += 1;
    ...
    begin
        ...
        /*E dans l'O*/
        Translations[86] [1] := 188;
        Translations[86] [2] := 140;
        /*e dans l'o*/
        Translations[87] [1] := 204;
        Translations[87] [2] := 156;
        //<<LAP2.14
