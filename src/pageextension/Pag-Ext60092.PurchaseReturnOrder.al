pageextension 60092 "PWD PurchaseReturnOrder" extends "Purchase Return Order"
{
    ...
    layout
    {
        ...
        {
            field("PWD Buy-from Vendor Name 2"; Rec."Buy-from Vendor Name 2")
            {
                ApplicationArea = All;
            }
        }
        ...
        {
            field("PWD Vendor Order No."; Rec."Vendor Order No.")
            {
                ApplicationArea = All;
            }
        }
        ...
        {
            field("PWD Sell-to Customer No."; Rec."Sell-to Customer No.")
            {
                ApplicationArea = All;
            }
        }
