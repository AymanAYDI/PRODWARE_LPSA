report 99084 "Update Gam OF PIERRES Visitage"
{
    ProcessingOnly = true;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING(Status, "No.") WHERE(Status = FILTER(<= Released), "Location Code" = FILTER(<> 'ACI'), "No." = FILTER(>= 'OF141140'));
            ...
            begin
                ...
                if ProdOrderRtngLine.FindFirst then
                    repeat
                        ...
                        /*
                        IF RoutingLine."No." = 'OP11720' THEN BEGIN
                          PORL.SETRANGE(PORL."Prod. Order No.", "No.");
                          PORL.SETRANGE(Type,PORL.Type::"Machine Center");
                          PORL.SETRANGE("No.",'OP11710');
                          IF NOT PORL.FINDFIRST THEN
