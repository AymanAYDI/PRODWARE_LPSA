report 50071 "PWD Inventory Purchase Orders"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/rdl/InventoryPurchaseOrders.rdl';
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            begin
                ...
                ItemDescription := "PWD LPSA Description 1" + ' ' + "PWD LPSA Description 2";
                //<<LAP.TDL.09/10/2014 :
            end;
        }
    }
